...
namespace undir {
 ...
 oslomnet_evaluate::oslomnet_evaluate(deque<deque<int> > & b, deque<deque<pair<int, double> > > & c, deque<int> & d): oslomnet_louvain() { set_graph(b,c,d); set_maxbord(); set_changendi_cum(); };
	oslomnet_evaluate::oslomnet_evaluate(string a): oslomnet_louvain() { set_graph(a); set_maxbord(); set_changendi_cum(); };
	oslomnet_evaluate::oslomnet_evaluate(map<int, map<int, pair<int, double> > > & A) : oslomnet_louvain() { set_graph(A);  set_maxbord(); set_changendi_cum(); };
	oslomnet_evaluate::~oslomnet_evaluate(){};
...
double oslomnet_evaluate::CUP_check(const deque<int> & _c_, deque<int> & gr_cleaned ) {
	return CUP_check(_c_,gr_cleaned, paras->clean_up_runs);
}


double oslomnet_evaluate::CUP_check(const deque<int> & _c_, deque<int> & gr_cleaned, int number_of_runs) {
...
double oslomnet_evaluate::CUP_both(const deque<int> & _c_, deque<int> & gr_cleaned ) {
	return CUP_both(_c_,gr_cleaned, paras->clean_up_runs);
}
double oslomnet_evaluate::CUP_both(const deque<int> & _c_, deque<int> & gr_cleaned, int number_of_runs  ) {
...
double oslomnet_evaluate::group_inflation(const deque<int> & _c_, deque<int> & gr_cleaned) {
	return group_inflation(_c_,gr_cleaned, paras->inflate_runs);
}
double oslomnet_evaluate::group_inflation(const deque<int> & _c_, deque<int> & gr_cleaned, int number_of_runs) {
